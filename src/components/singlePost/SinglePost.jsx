	...
	return (
		<div className="singlePost">
			<div className="singlePostWrapper">
				{post.img && (
					<img className="singlePostImg" src={PF + post.img} alt="img"></img>
				)}
				{updateMode ? (
					<input
						type="text"
					...
					<>
						<div className="grow-wrapEdit">
							<textarea
								...
								onFocus={(e) =>
									(e.target.parentNode.dataset.replicatedValue = desc)
								}
								autoFocus
							/>
						</div>
						<button
							type="submit"
							className="updatePostBtn btn btn-outline-success"
